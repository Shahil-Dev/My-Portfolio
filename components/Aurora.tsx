...
export default function Aurora(props: AuroraProps) {
  const { colorStops = ['#00C6FF', '#0072FF', '#3A1C71'], amplitude = 1.0, blend = 0.5 } = props;
  ...
  return <div ref={ctnDom} className="absolute inset-0 w-full h-full pointer-events-none opacity-40 dark:opacity-60" />;
}