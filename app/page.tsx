    ...
    >
      ...
      <div className="relative z-10 my-auto flex max-w-4xl flex-col items-start pt-10 pb-16">
        ...
        <div className="mt-12 flex flex-wrap items-center gap-4">
          <a
            href="#work"
            className="group inline-flex items-center justify-center gap-2.5 rounded-sm  px-5 py-2.5 text-sm font-medium transition-colors  shadow-sm"
          >
            Explore Systems
            <ArrowUpRight className="h-4 w-4 text-zinc-500 transition-transform duration-200 ease-out group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-zinc-950" />
          </a>

          <a
            href="#contact"
            className="inline-flex items-center justify-center rounded-sm border border-zinc-800 bg-zinc-900/30 px-5 py-2.5 text-sm font-medium text-zinc-300 transition-colors hover:bg-zinc-900 hover:text-zinc-100 hover:border-zinc-700 backdrop-blur-sm"
          >
            Initiate Contact
          </a>
        </div>
